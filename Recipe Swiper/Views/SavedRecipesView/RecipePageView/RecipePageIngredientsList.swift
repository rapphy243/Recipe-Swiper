//
//  IngredientsListComponent.swift
//  Recipe Swiper
//
//  Created by Raphael Abano on 8/11/25.
//


import SwiftUI

struct RecipePageIngredientsList: View {
...
#Preview {
    RecipePageIngredientsList(recipe: RecipeModel(from: Recipe.Cake))
}
